...
const Navbar = () => {
  return (
    <header className="h-[50px] w-8/12 mx-auto z-40 my-4 flex justify-between text-[#2b2f38]">
      <Link href="/">
        <div className="flex">
          <Image src={logo} width={50} height={50} alt='Logo' />
          <h1 className="my-auto ml-2 text-xl font-medium text-[#2b2f38]">Simply Natural</h1>
        </div>
      </Link>
